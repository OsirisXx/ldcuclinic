...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "View upcoming clinic schedules at Liceo de Cagayan University",
    },
  ];
};
...
export default function ViewSchedules() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [settingsRes, appointmentsRes, limitsRes, campusesRes] =
        await Promise.all([
  ...
  const slotDurationMinutes = Math.max(
    10,
    Math.floor(totalMinutesPerDay / dailyLimit)
  );
      ...
      <div className="max-w-[95%] mx-auto px-2 sm:px-3 lg:px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">
            View upcoming appointment schedules. Visit the clinic to book your
            appointment.
          </p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4 border-t">
                ...
                <p className="text-xs text-gray-600">
                  Visit the clinic and speak with our staff to schedule your
                  appointment.
                </p>
              </div>
            </CardContent>
                    ...
                    >
                      ...
                      <thead className="bg-gray-50 sticky top-0 z-10">
                        <tr className="border-b">
                          <th
                            className="p-3 text-center text-xs font-medium text-gray-500 border-r bg-gray-50"
                            style={{ width: "80px" }}
                          >
                            Time
                          </th>
                            ...
                            return (
                              <th
                                ...
                                className={`p-2 text-center border-r font-normal ${
                                  ...
                                  isToday ? "bg-maroon-50" : "bg-gray-50"
                                }`}
                              >
                      ...
                      <tbody>
                        {timeSlots.map((slot) => (
                          ...
                          >
                            <td
                              className="p-2 text-xs text-gray-500 border-r text-center font-medium align-middle"
                            ...
                            {weekDays.map((date, idx) => {
                              ...
                              const isConfigured = isDayConfigured(date);
                              const appointments = getSlotAppointments(
                                dateStr,
                                slot.start,
                                slot.end
                              );
                              ...
                              if (!isConfigured || isPast) {
                                return (
                                  <td
                                    ...
                                    className={`p-1 border-r bg-gray-100 align-top ${
                                      idx === 6 ? "border-r-0" : ""
                                    }`}
                                    style={{ height: "56px" }}
                                  />
                                      ...
                                      {appointments
                                        ...
                                        .map((appt: any, i: number) => {
                                          ...
                                          if (appt.status === "completed") {
                                            ...
                                            statusBg =
                                              "bg-red-100 text-red-800 border-l-4 border-red-500 line-through opacity-60";
                                            statusIndicator = "✗";
                                          } else if (
                                            appt.status === "no_show"
                                          ) {
        ...
        <div className="bg-maroon-50 border border-maroon-200 rounded-lg p-6 text-center">
          <h3 className="text-lg font-semibold text-maroon-900 mb-2">
            Want to Book an Appointment?
          </h3>
          <p className="text-maroon-700 mb-4">
            Visit the Liceo de Cagayan University Clinic and our staff will
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-md font-medium text-maroon-800">
                    {campuses.find(
                      (c: any) => c.id === selectedAppointment.campus_id
                    )?.name || "Unknown"}
                  </p>
                </div>
                <div>
